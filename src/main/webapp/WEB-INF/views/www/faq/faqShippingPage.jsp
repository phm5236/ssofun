                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-3">
                                                                                        <div class="checks" style="padding: 0;">
                                                                                            <input type="radio" id="helpfulRadio${faq.faq_id}" name="helpStatus${faq.faq_id }" id="helpfulRadio${faq.faq_id}" value="helpful">  
                                                                                            <label for="helpfulRadio${faq.faq_id}">예</label>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-6">
                                                                                      <div class="checks" style="padding: 0;">
                                                                                            <input type="radio"  id="unhelpfulRadio${faq.faq_id}" name="helpStatusRadio${faq.faq_id}" value="unhelpful">
