...
public class ProductReviewJiDto {
	...
	private String url; // 이미지출력
	@JsonFormat(pattern = "yyyy-MM-dd:HH.mm.ss",  timezone = "Asia/Seoul") //데이터 포맷 변환
	private Date created_at; // 등록일
	private int used_fg; // 사용여부
	
	public ProductReviewJiDto() {
		super();
	}

	public ProductReviewJiDto(int product_review_id, int product_order_item_id, int user_id, int product_id, int rate,
			String contents, String uname, String url, Date created_at, int used_fg) {
		super();
