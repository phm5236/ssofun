...
public class ProductFavoritCountDto {
	...
	public ProductFavoritCountDto() {
		super();
	}
	
	public ProductFavoritCountDto(int product_favorit_id, int product_id, int user_id, int count, Date created_at,
			int used_fg) {
		super();
